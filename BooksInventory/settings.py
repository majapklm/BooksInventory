"""
Django settings for BooksInventory project.
...
SECRET_KEY = '5uf=ngfb1=kwu%k^v#ws4=4yt1(@^7m83pklg9nn&0_0a+n3(e'
...
DATABASES = {
    'default': {
            ...
            'NAME': 'BooksInventory',  # Or path to database file if using sqlite3.
